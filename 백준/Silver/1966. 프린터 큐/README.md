...
### 출력 
 ...
 <p>idx와 우선순위 둘 다 고려하려니까 for 문을 중복으로 사용해야 해서 아닌 것 같아서 GPT 씀</p>
 <p>idx와 우선순위를 하나의 튜플로 묶어서 deque의 원소로 한다.</p>
 <p> "if any(cur[0] < other[0] for other in q):" 처음 본다.</p>
